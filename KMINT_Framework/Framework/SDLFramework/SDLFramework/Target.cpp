...
void Target::update()
{
	...
	for (int i = 0; i < matrix_.size(); i++)
		matrix_[i] = matrix_[i] * MF::translate3d(-500, -500, 0) * MF::scale3d(scaleFactor_, scaleFactor_, scaleFactor_) * MF::translate3d(500, 500, 0);
}
